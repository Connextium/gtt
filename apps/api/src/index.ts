...
export const apiRouteContracts: ApiRouteContract[] = [
  ...[
    ...
    ["POST", "/admin/bootstrap/super-admin", "api-auth"],
    ["POST", "/internal-access/initialize", "api-auth"],
    ["POST", "/internal-access/login", "api-auth"],
    ["GET", "/onboarding/me", "client-onboarding"],
    ...
    ["POST", "/admin/business-onboarding/applications/{id}/request-info", "client-onboarding"],
    ["POST", "/admin/business-onboarding/applications/{id}/reject", "client-onboarding"],
    ...
    ["POST", "/accounts-of-digital-asset/{id}/activate", "digital-accounts"],
    ["POST", "/accounts-of-digital-asset/{id}/provision-circle", "digital-accounts"],
    ["POST", "/accounts-of-digital-asset/{id}/restrict", "digital-accounts"],
    ["POST", "/accounts-of-digital-asset/{id}/unrestrict", "digital-accounts"],
    ["POST", "/accounts-of-digital-asset/{id}/freeze", "digital-accounts"],
    ["POST", "/accounts-of-digital-asset/{id}/unfreeze", "digital-accounts"],
    ["POST", "/accounts-of-digital-asset/{id}/close", "digital-accounts"],
    ["POST", "/accounts-of-digital-asset/{id}/linked-instruments", "digital-accounts"],
    ["GET", "/accounts-of-digital-asset/{id}/linked-instruments", "digital-accounts"],
    ["GET", "/accounts-of-digital-asset/{id}/provider-mappings", "digital-accounts"],
    ...
    ["POST", "/ledger/events/opening-journal", "ledger"],
    ...
    ["POST", "/fiat/wire-accounts/{id}/mint", "payment-execution"],
    ["GET", "/fiat/mints", "payment-execution"],
    ["POST", "/fiat/funding-instructions", "payment-execution"],
    ["GET", "/fiat/funding-instructions", "payment-execution"],
    ["GET", "/funding-instructions", "payment-execution"],
    ["GET", "/funding-instructions/{id}", "payment-execution"],
    ["GET", "/funding-instructions/{id}/orders", "payment-execution"],
    ["POST", "/funding-instructions", "payment-execution"],
    ["POST", "/funding-instructions/{id}/assign-route", "payment-execution"],
    ["POST", "/funding-instructions/{id}/cancel", "payment-execution"],
    ...
    ["POST", "/webhooks/circle/onboarding", "circle-integration"],
    ["GET", "/webhooks/circle/events", "circle-integration"],
    ["POST", "/webhooks/circle/events/{id}/retry", "circle-integration"],
    ["POST", "/internal/webhooks/circle/{eventId}/reprocess", "circle-integration"],
    ...
    ["GET", "/audit-events", "events"],
    ["GET", "/tenants/current/activation", "tenant-activation"],
    ["POST", "/tenants/current/activate", "tenant-activation"],
    ["GET", "/integrations/circle/health", "circle-integration"],
    ["POST", "/integrations/circle/sandbox-check", "circle-integration"],
    ["GET", "/internal/operations/commandcentre", "reporting"],
...
let handleVercelRequest: ((request: IncomingMessage, response: ServerResponse) => Promise<void>) | undefined;

export default async function handler(request: IncomingMessage, response: ServerResponse): Promise<void> {
  const { createApiRequestHandler } = await import("./server.js");
  handleVercelRequest ??= createApiRequestHandler();
